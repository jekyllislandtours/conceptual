...
(deftest union-test
  ...
  (testing "this works because of the new impl which uses IntArrayList."
    (expect [2 3 6 7 8 9 10] (vec (i/union (int-array [2 10 3]) (int-array [6 7 8 9])))))
...
(deftest intersection-test
  ...
  (expect [] (vec (apply i/intersection (into-array int/1 [nil nil nil]))))
  (expect [] (vec (i/intersection nil)))
  (expect [] (vec (apply i/intersection (into-array int/1 [(int-array [2])
                                                           nil
                                                           (int-array [2 3 5])]))))
...
(deftest difference-test
  ...
  (expect [] (vec (i/difference nil)))
  (expect [] (vec (apply i/difference (into-array int/1 [nil nil]))))
...
(deftest difference!-test
  ...
  (testing "this returns the correct result if the first item is sorted"
    (expect [2 5] (vec (i/difference! (int-array [2 3 5]) (int-array [3 6 7 8 9]))))
    (expect [2 5] (vec (i/difference! (int-array [2 3 5]) (int-array [6 7 8 9 3]))))
    (expect [6 7 8 9 3] (vec (i/difference! (int-array [6 7 8 9 3]) (int-array [2 3 5]))))))
...
(deftest index-test
  (expect 0 (i/index (int-array [1]) 1))
  (expect 0 (i/index (int-array [1 2]) 1))
  (expect 1 (i/index (int-array [1 2]) 2))
  (expect -1 (i/index (int-array [1 2]) 3))
  (expect -1 (i/index (int-array [1]) 2))
  (expect -1 (i/index nil 3))
  (expect -1 (i/index nil nil))
  (expect -1 (i/index (int-array []) nil)))
...
(deftest filter-test
  (expect [] (vec (i/filter identity (i/set))))
  (expect [] (vec (i/filter identity [])))
  (expect [] (vec (i/filter identity [nil])))
  (expect [2 4] (vec (i/filter even? (i/set [1 2 3 4]))))
  (expect [2 4] (vec (i/filter even? [1 2 3 4]))))

(deftest remove-test
  (expect [] (vec (i/remove identity (i/set))))
  (expect [] (vec (i/remove identity [])))
